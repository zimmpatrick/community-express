...
public sealed class SteamUnity : MonoBehaviour
{	
	...
	private static SteamUnity _instance;
	...
	public bool Awake()
	{
		...
		_leaderboards = null;
		_matchmaking = null;
		_gameserverUserStatsReceivedCallHandles = new List<SteamAPICall_t>();
		_gameserverUserStatsReceivedCallbacks = new List<OnUserStatsReceivedFromSteam>();
		_gamestatsSessionIssuedCallHandles = new List<SteamAPICall_t>();
		_gamestatsSessionIssuedCallbacks = new List<OnGameStatsSessionIssuedBySteam>();
	...
	public GameStats CreateNewGameStats(OnGameStatsSessionInitialized onGameStatsSessionInitialized, Boolean gameserver, SteamID steamID)
	{
		GameStats gamestats;
