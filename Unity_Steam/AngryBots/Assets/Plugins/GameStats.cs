...
namespace SteamworksUnityHost
{
	...
	public delegate void OnGameStatsSessionIssuedBySteam(ref GameStatsSessionIssued_t CallbackData);
	...
	public class GameStats
	{
		...
		public void StartNewSession(OnGameStatsSessionInitialized onGameStatsSessionInitialized, EGameStatsAccountType accountType, SteamID accountID)
		{
			if (_initialized)
			{
				EndCurrentSession();
