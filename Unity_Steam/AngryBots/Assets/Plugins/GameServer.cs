...
namespace SteamworksUnityHost
{
	...
	public delegate void OnGameServerClientApprovedBySteam(ref GSClientApprove_t callbackData);
	public delegate void OnGameServerClientApproved(SteamID approvedPlayer);

	public delegate void OnGameServerClientDeniedBySteam(ref GSClientDeny_t callbackData);
	...
	public delegate void OnGameServerPolicyResponseFromSteam(ref GSPolicyResponse_t callbackData);
