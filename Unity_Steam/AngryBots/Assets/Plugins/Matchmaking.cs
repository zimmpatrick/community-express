...
namespace SteamworksUnityHost
{
	...
	public delegate void OnMatchmakingLobbyCreatedBySteam(ref LobbyCreated_t callbackData);
	public delegate void OnLobbyCreated(Lobby lobby);
	public delegate void OnMatchmakingLobbyListReceivedFromSteam(ref LobbyMatchList_t callbackData);
	public delegate void OnLobbyListReceived(Lobbies lobbies);
	public delegate void OnMatchmakingLobbyJoinedFromSteam(ref LobbyEnter_t callbackData);
	public delegate void OnLobbyJoined(Lobby lobby, EChatRoomEnterResponse chatRoomEnterResponse);

	public delegate void OnMatchmakingServerReceivededFromSteam(HServerListRequest request, ref gameserveritem_t callbackData);
	public delegate void OnMatchmakingServerListReceivededFromSteam(HServerListRequest request);
