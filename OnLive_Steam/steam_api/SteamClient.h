...
class SteamClient : public ISteamClient
{
public:
	// Creates a communication pipe to the Steam client
	virtual HSteamPipe CreateSteamPipe()
	{
		TRACE( TEXT("CreateSteamPipe()") );
		return 0;
	}
	...
	{
		TRACE( TEXT("BReleaseSteamPipe(%d)"), hSteamPipe );
		return true;
	}
	...
	{
		TRACE( TEXT("ConnectToGlobalUser(%d)"), hSteamPipe );
		return 0;
	}
	...
	{
		TRACE( TEXT("ConnectToGlobalUser(%x,%d)"), phSteamPipe, (int)eAccountType );
		return 0;
	}
	...
	{
		TRACE( TEXT("GetISteamGameServer(%d,%d,'%s')"), hSteamPipe, hSteamPipe, pchVersion );
	...
	{
		TRACE( TEXT("GetISteamGenericInterface(%d,%d,'%s')"), hSteamPipe, hSteamPipe, pchVersion );
		return 0;
	}
	...
	{
		TRACE( TEXT("GetISteamNetworking(%d,%d,'%s')"), hSteamPipe, hSteamPipe, pchVersion );
	...
	{
		TRACE( TEXT("GetISteamRemoteStorage(%d,%d,'%s')"), hSteamPipe, hSteamPipe, pchVersion );
